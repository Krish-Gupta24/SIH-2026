...
class OutputVariableRegistry:
    ...
    _VARIABLES: List[OutputVariableSpec] = [
        ...
        OutputVariableSpec(
            ...
            is_required=False,  # only required when windows exist
            description="Instantaneous rate of transmitted beam and diffuse solar radiation through specific window glazing",
        ),
        OutputVariableSpec(
            metric="zone_windows_total_transmitted_solar_rate",
            ep_variable_name="Zone Windows Total Transmitted Solar Radiation Rate",
            unit="W",
            frequency="Hourly",
            parser_key="solar_gains_total",
            category=OutputCategory.SOLAR,
            concept="transmitted solar radiation where supported",
            is_required=True,
            description="Sum of all transmitted solar radiation entering zone through all fenestration apertures",
        ),
        OutputVariableSpec(
            metric="zone_windows_total_transmitted_solar_energy",
            ep_variable_name="Zone Windows Total Transmitted Solar Radiation Energy",
            unit="J",
            frequency="Hourly",
