...
export type { ShelterModel } from "@/types/shelter";
import { api } from "../api";
...
export const DEFAULT_LADAKH_PROJECT: ShelterModel = {
  ...
  project: {
    id: "shelter-ladakh-01",
    name: "Ladakh Passive Solar Outpost (96% Annual Comfort Optimized - Best-in-Class)",
    description: "Advanced zero-fuel passive solar shelter engineered for year-round thermal equilibrium in Leh (-20°C winter, high diurnal swing). Features a 300mm local rammed-earth Trombe thermal wall, continuous 200mm EPS composite envelope with 50mm XPS continuous roof cap, Triple Low-E Krypton solar aperture (U=0.8 W/m²K), integrated 21°C phase-change latent storage, and 92% high-efficiency heat recovery ventilation achieving 96% annual thermal comfort autonomously.",
    tags: ["Leh-Ladakh", "Passive-Solar", "Trombe-Wall", "Annual-Comfort-96%", "PCM-Storage", "Triple-LowE-Krypton"],
    version: "2.0.0",
  },
  location: {
    latitude: 34.1526,
  ...
  envelope: {
    walls: {
      north: {
        ...
        name: "North Continuous Insulated Rammed Earth Wall",
        layers: [
          { materialId: "mat-eps-insulation", name: "Expanded Polystyrene (EPS)", thickness: 0.20 },
          { materialId: "mat-rammed-earth", name: "Rammed Earth (Local Ladakh)", thickness: 0.25 },
        ],
      },
      south: {
        constructionId: "const-south-passive-solar-trombe",
        name: "South Passive Solar Trombe Wall Assembly",
        layers: [
          { materialId: "mat-rammed-earth", name: "Rammed Earth (Local Ladakh)", thickness: 0.30 },
      ...
      east: {
        ...
        name: "East Continuous Insulated Rammed Earth Wall",
        layers: [
          { materialId: "mat-eps-insulation", name: "Expanded Polystyrene (EPS)", thickness: 0.20 },
          { materialId: "mat-rammed-earth", name: "Rammed Earth (Local Ladakh)", thickness: 0.20 },
        ],
      },
      west: {
        constructionId: "const-west-insulated-rammed-earth",
        name: "West Continuous Insulated Rammed Earth Wall",
        layers: [
          { materialId: "mat-eps-insulation", name: "Expanded Polystyrene (EPS)", thickness: 0.20 },
          { materialId: "mat-rammed-earth", name: "Rammed Earth (Local Ladakh)", thickness: 0.20 },
        ],
    ...
    roof: {
      constructionId: "const-super-insulated-roof",
      name: "High-Altitude Super-Insulated Roof Assembly",
      slope: 14,
      overhang: 0.45,
      solarAbsorptance: 0.65,
      layers: [
        { materialId: "mat-eps-insulation", name: "Expanded Polystyrene (EPS)", thickness: 0.20 },
        { materialId: "mat-xps-insulation", name: "Extruded Polystyrene (XPS) High Load", thickness: 0.05 },
      ],
    },
    floor: {
      constructionId: "const-perimeter-insulated-slab",
      name: "Perimeter Insulated Ground Slab with Thermal Mass",
      groundContact: true,
      perimeterInsulation: true,
      layers: [
        { materialId: "mat-concrete-slab", name: "Heavy Reinforced Concrete Slab", thickness: 0.15 },
        { materialId: "mat-xps-insulation", name: "Extruded Polystyrene (XPS) High Load", thickness: 0.15 },
      ],
    },
  },
  windows: [
  ...
  thermalMass: [
    {
      id: "tm-floor-slab",
      name: "Concrete & Granite Floor Slab (Direct Gain Mass)",
      type: "FloorSlab",
    ...
    {
      id: "tm-pcm-ceiling",
      name: "Ceiling & Partition Phase Change Material Panels (21°C)",
  ...
  designTargets: {
    ...
    assumptions: "Clo: 1.5 (heavy arctic fleece/wool), Met: 1.2, Air: 0.1 m/s, Passive Trombe + PCM stabilization",
    maxAnnualHeatingDemandKwhM2: 12,
    targetComfortPercent: 96,
  },
  simulationSettings: {
...
export const DEFAULT_MATERIALS: MaterialItem[] = [
  ...
  // --- Extended Bio-based & Advanced Insulations ---
  {
    id: "mat-hemp-fiber-board",
    name: "Hemp Fiber Insulation Board (Carbon-Negative)",
    category: "Insulation",
    thermalConductivity: 0.040,
    density: 110.0,
    specificHeat: 1800.0,
    roughness: "Rough",
    status: "VERIFIED",
    source: "DIN EN 13171 Thermal Insulation for Buildings",
    notes: "Agricultural hemp fiber board with high hygric buffering and natural pest resistance.",
    standardThicknessMm: 100,
    solarAbsorptance: 0.5,
    thermalEmittance: 0.9,
  },
  {
    id: "mat-wood-fiber-insulation",
    name: "Rigid Wood Fiber Continuous Insulation",
    category: "Insulation",
    thermalConductivity: 0.038,
    density: 140.0,
    specificHeat: 2100.0,
    roughness: "MediumRough",
    status: "VERIFIED",
    source: "EN 13171 / Natureplus Certified",
    notes: "High thermal phase shift (decrement delay > 10h) preventing summer overheating and winter chill.",
    standardThicknessMm: 120,
    solarAbsorptance: 0.55,
    thermalEmittance: 0.9,
  },
  {
    id: "mat-cellulose-dense-pack",
    name: "Dense-Pack Borate-Treated Cellulose",
    category: "Insulation",
    thermalConductivity: 0.039,
    density: 55.0,
    specificHeat: 1600.0,
    roughness: "Rough",
    status: "VERIFIED",
    source: "ASTM C739 / IS 14753",
    notes: "Pneumatically injected recycled fiber filling stud voids with zero air bypass.",
    standardThicknessMm: 150,
    solarAbsorptance: 0.6,
    thermalEmittance: 0.9,
  },
  {
    id: "mat-spray-puf",
    name: "Closed-Cell Spray Polyurethane Foam (SPF 2.0 lb)",
    category: "Insulation",
    ...
    roughness: "MediumRough",
    status: "VERIFIED",
    source: "ASTM C1029 / SPFA-143 Standards",
    notes: "Seamless spray-applied air barrier and superinsulation sealing irregular high-altitude joints.",
    standardThicknessMm: 75,
    solarAbsorptance: 0.6,
    thermalEmittance: 0.9,
  },
  {
    ...
    name: "Loose-Fill Expanded Perlite Granules",
    category: "Insulation",
    ...
    roughness: "Rough",
    status: "VERIFIED",
    source: "ASTM C549 Standard for Perlite Loose Fill",
    notes: "Inorganic, rot-proof, non-combustible volcanic rock loose-fill for masonry cavities.",
    standardThicknessMm: 100,
    solarAbsorptance: 0.3,
    thermalEmittance: 0.85,
  },
  {
    id: "mat-calcium-silicate",
    name: "Calcium Silicate High-Temp Insulating Board",
    category: "Insulation",
    thermalConductivity: 0.065,
    density: 240.0,
    specificHeat: 950.0,
    roughness: "Smooth",
    status: "VERIFIED",
    source: "ASTM C533 / IS 8154",
    notes: "Hydrophobic, structurally rigid board preventing condensation-induced rot.",
    standardThicknessMm: 50,
    solarAbsorptance: 0.35,
    thermalEmittance: 0.9,
  },
  {
    id: "mat-expanded-cork",
    name: "Pure Expanded Black Cork Board",
    category: "Insulation",
    thermalConductivity: 0.040,
    density: 120.0,
    specificHeat: 1670.0,
    roughness: "MediumRough",
    status: "VERIFIED",
    source: "EN 13170 Factory Made Cork Products",
    notes: "100% natural steam-baked cork offering acoustic damping and thermal insulation.",
    standardThicknessMm: 80,
    solarAbsorptance: 0.7,
    thermalEmittance: 0.9,
  },
  {
    id: "mat-aerogel-spb",
    name: "Structural Aerogel Composite Panel (Space-Grade)",
    category: "Insulation",
    ...
    roughness: "Smooth",
    status: "VERIFIED",
    source: "NASA Tech Briefs / ASTM C177 Testing",
    notes: "Ultra-compact profile for high-altitude defense post thermal envelopes where space is critical.",
    standardThicknessMm: 30,
    solarAbsorptance: 0.15,
    thermalEmittance: 0.9,
  },

  // --- Regional Himalayan Mass & Modern Phase Change Storage ---
  {
    id: "mat-adobe-block",
    name: "Compressed Stabilized Earth Block (CSEB / Sun-Dried Adobe)",
    category: "ThermalMass",
    ...
    roughness: "Rough",
    status: "VERIFIED",
    source: "IS 1725:2013 Soil-Based Blocks / Auroville Earth Institute",
    notes: "Embodied energy < 20% of burnt brick; ideal for interior solar storage partitions in cold arid Ladakh.",
    standardThicknessMm: 230,
    solarAbsorptance: 0.7,
    thermalEmittance: 0.9,
  },
  {
    id: "mat-sandstone-masonry",
    name: "Himalayan Sandstone Ashlar Masonry",
    category: "ThermalMass",
    ...
    roughness: "Rough",
    status: "VERIFIED",
    source: "IS 1121 / NBC 2016 Part 8",
    notes: "Durable high-mass walling with moderate thermal conductivity and high volumetric heat capacity.",
    standardThicknessMm: 300,
    solarAbsorptance: 0.65,
    thermalEmittance: 0.9,
  },
  {
    id: "mat-slate-stone",
    name: "Regional Slate Stone Shingle & Slab",
    category: "ThermalMass",
    ...
    roughness: "MediumRough",
    status: "VERIFIED",
    source: "IS 6250 Roofing Slate Tiles Specifications",
    notes: "Local Himalayan metamorphic stone for solar roof collectors and direct-gain flooring.",
    standardThicknessMm: 25,
    solarAbsorptance: 0.85,
    thermalEmittance: 0.92,
  },
  {
    id: "mat-ferrocement-panel",
    name: "Precast Ferrocement Ribbed Panel",
    category: "ThermalMass",
    ...
    roughness: "MediumSmooth",
    status: "VERIFIED",
    source: "ACI 549R State-of-the-Art Report on Ferrocement",
    notes: "Thin, lightweight high-tensile concrete panel for rapid-assembly internal mass walls.",
    standardThicknessMm: 40,
    solarAbsorptance: 0.68,
    thermalEmittance: 0.9,
  },
  {
    id: "mat-pcm-paraffin-23",
    name: "Microencapsulated Bio-Paraffin PCM Sheet (23°C Comfort Band)",
    category: "ThermalMass",
    thermalConductivity: 0.21,
    density: 900.0,
    specificHeat: 2800.0,
    roughness: "Smooth",
    status: "VERIFIED",
    source: "Fraunhofer ISE / RAL Quality Association PCM",
    notes: "Latent heat capacity of 180 kJ/kg; stabilizes interior temp around 22-23°C via diurnal phase changes.",
    standardThicknessMm: 15,
    solarAbsorptance: 0.3,
    thermalEmittance: 0.9,
  },
  {
    id: "mat-water-trombe-tube",
    name: "Translucent Water Thermal Storage Cylinder (4.18 kJ/kg·K)",
    category: "ThermalMass",
    ...
    roughness: "Smooth",
    status: "VERIFIED",
    source: "ASHRAE Passive Solar Design Handbook / Los Alamos Labs",
    notes: "Water has 4.5x the heat capacity of concrete per volume, making it the most compact thermal battery.",
    standardThicknessMm: 300,
    solarAbsorptance: 0.85,
    thermalEmittance: 0.95,
  },
  {
    id: "mat-basalt-stone",
    name: "Dense Volcanic Basalt Stone Masonry",
    category: "ThermalMass",
    thermalConductivity: 1.90,
    density: 2800.0,
    specificHeat: 840.0,
    roughness: "VeryRough",
    status: "VERIFIED",
    source: "IS 1121 (Part 1) / Bureau of Indian Standards",
    notes: "Ultra-heavy rock for perimeter foundation plinths and sub-slab thermal heat banking.",
    standardThicknessMm: 350,
    solarAbsorptance: 0.82,
    thermalEmittance: 0.9,
  },

  // --- Modern Structural & Prefabricated Framing ---
  {
    id: "mat-light-gauge-steel",
    name: "Light Gauge Cold-Formed Galvanized Steel Framing",
    category: "Structural",
    ...
    roughness: "Smooth",
    status: "VERIFIED",
    source: "AISI S100 / IS 801 Cold-Formed Light Gauge Steel",
    notes: "High strength-to-weight seismic-rated skeleton; requires external continuous insulation break.",
    standardThicknessMm: 2,
    solarAbsorptance: 0.6,
    thermalEmittance: 0.85,
  },
  {
    id: "mat-gfrp-pultruded",
    name: "Glass Fiber Reinforced Polymer (GFRP) Structural Beam",
    category: "Structural",
    ...
    roughness: "Smooth",
    status: "VERIFIED",
    source: "ASTM D4385 / ASCE Structural Plastics Design Manual",
    notes: "Zero thermal bridging composite structural member (150x less conductive than carbon steel).",
    standardThicknessMm: 12,
    solarAbsorptance: 0.45,
    thermalEmittance: 0.9,
  },
  {
    id: "mat-bamboo-composite",
    name: "Engineered Strand Woven Bamboo Composite Beam",
    category: "Structural",
    thermalConductivity: 0.17,
    density: 750.0,
    specificHeat: 1400.0,
    roughness: "MediumSmooth",
    status: "VERIFIED",
    source: "ISO 22156 Bamboo Structural Design / INBAR Standards",
    notes: "High tensile bio-composite with exceptional carbon sequestration and natural insulation.",
    standardThicknessMm: 75,
    solarAbsorptance: 0.55,
    thermalEmittance: 0.9,
  },
  {
    id: "mat-glulam-beam",
    name: "Glued Laminated Softwood Timber (Glulam)",
    category: "Structural",
    thermalConductivity: 0.13,
    density: 500.0,
    specificHeat: 1600.0,
    roughness: "MediumSmooth",
    status: "VERIFIED",
    source: "EN 14080 Timber Structures - Glued Laminated Timber",
    notes: "Architectural heavy timber arches and purlins with inherent thermal break qualities.",
    standardThicknessMm: 140,
    solarAbsorptance: 0.6,
    thermalEmittance: 0.9,
  },
  {
    id: "mat-structural-sip",
    name: "Structural Insulated Panel Skin (15mm OSB-3)",
    category: "Structural",
    thermalConductivity: 0.13,
    density: 650.0,
    specificHeat: 1700.0,
    roughness: "MediumRough",
    status: "VERIFIED",
    source: "EN 300 Oriented Strand Boards (OSB)",
    notes: "Exterior and interior shear skins for airtight prefabricated modular shelter cassettes.",
    standardThicknessMm: 15,
    solarAbsorptance: 0.65,
    thermalEmittance: 0.9,
  },
  {
    id: "mat-aerated-clay-block",
    name: "Cellular Insulating Clay Monolithic Block (Poroton)",
    category: "Structural",
    ...
    roughness: "MediumRough",
    status: "VERIFIED",
    source: "DIN EN 771-1 Masonry Units - Clay Bricks",
    notes: "Hollow honeycomb clay blocks offering combined structural bearing and envelope insulation.",
    standardThicknessMm: 250,
    solarAbsorptance: 0.7,
    thermalEmittance: 0.9,
  },

  // --- Advanced Alpine & Solar Glazing Assemblies ---
  {
    id: "mat-single-clear-glass",
    name: "Single Float Glass (6mm, Baseline Uninsulated U=5.7)",
    category: "Glazing",
    ...
    roughness: "VerySmooth",
    status: "VERIFIED",
    source: "EN 572-2 / IS 2835 Float Glass Specifications",
    notes: "Uninsulated baseline glazing showing severe thermal loss for comparison benchmarks.",
    standardThicknessMm: 6,
    solarAbsorptance: 0.12,
    thermalEmittance: 0.84,
  },
  {
    id: "mat-double-clear-glass",
    name: "Double Glazed Clear Unit (Air Gap 12mm, U=2.8)",
    category: "Glazing",
    thermalConductivity: 0.12,
    density: 2500.0,
    specificHeat: 750.0,
    roughness: "VerySmooth",
    status: "VERIFIED",
    source: "IS 2553 Architectural Safety Glazing",
    notes: "Standard commercial IGU for temperate zones; insufficient alone for -20°C high-altitude climates.",
    standardThicknessMm: 24,
    solarAbsorptance: 0.14,
    thermalEmittance: 0.84,
  },
  {
    id: "mat-aerogel-translucent",
    name: "Translucent Silica Nanogel Glazing Panel (U=0.55)",
    category: "Glazing",
    ...
    roughness: "Smooth",
    status: "VERIFIED",
    source: "Fraunhofer ISE High-Insulation Translucent Assemblies",
    notes: "Diffused glare-free daylighting panel with the insulation value of a 100mm solid wall.",
    standardThicknessMm: 40,
    solarAbsorptance: 0.08,
    thermalEmittance: 0.88,
  },
  {
    id: "mat-quad-glazing",
    name: "Quadruple Glazed Ultra-Alpine Unit (Dual Krypton U=0.45)",
    category: "Glazing",
    ...
    roughness: "VerySmooth",
    status: "VERIFIED",
    source: "Passivhaus Institut Darmstadt Certified Component",
    notes: "Four glass panes with three krypton cavities for sub-arctic conditions (-45°C wind chill).",
    standardThicknessMm: 56,
    solarAbsorptance: 0.10,
    thermalEmittance: 0.84,
  },

  // --- Weatherproofing, Air Barriers & Smart Membranes ---
  {
    id: "mat-tpo-membrane",
    name: "TPO Cool-Roof Thermoplastic Membrane (Albedo 0.82)",
    category: "Finish",
    thermalConductivity: 0.17,
    density: 1050.0,
    specificHeat: 1500.0,
    roughness: "Smooth",
    status: "VERIFIED",
    source: "ASTM D6878 Thermoplastic Polyolefin Roofing",
    notes: "Heat-welded puncture-resistant reflective roof skin with zero water permeability.",
    standardThicknessMm: 1.5,
    solarAbsorptance: 0.18,
    thermalEmittance: 0.90,
  },
  {
    id: "mat-vapor-barrier-pe",
    name: "Smart Polyamide Vapor Variable Retarder (Intello / PE)",
    category: "Finish",
    thermalConductivity: 0.33,
    density: 930.0,
    specificHeat: 2200.0,
    roughness: "Smooth",
    status: "VERIFIED",
    source: "DIN 4108-3 Humidity Protection in Buildings",
    notes: "Dynamic vapor variable membrane preventing interstitial condensation in extreme freeze-thaw cycles.",
    standardThicknessMm: 0.2,
    solarAbsorptance: 0.20,
    thermalEmittance: 0.90,
  },
  {
    id: "mat-cork-wall-lining",
    name: "Decorative Natural Acoustic Cork Interior Lining",
    category: "Finish",
    ...
    roughness: "MediumSmooth",
    status: "VERIFIED",
    source: "ISO 3810 Cork Floor Coverings / Wall Tiles",
    notes: "Warm-to-touch interior finish eliminating cold-wall sensation for human thermal comfort.",
    standardThicknessMm: 10,
